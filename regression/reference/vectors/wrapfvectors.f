...
module vectors_mod
    ...
    interface
        subroutine c_vector_of_pointers_bufferify(arg1, SHT_arg1_len, &
                SHT_arg1_size) &
        ...
        end subroutine c_vector_of_pointers_bufferify
    end interface
