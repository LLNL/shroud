...
module generic_mod
    ...
    interface nbcastinteger
        module procedure nbcastinteger_0d
        module procedure nbcastinteger_1d
        module procedure nbcastinteger_2d
        module procedure nbcastinteger_3d
...
contains
    ...
    ! Argument:  int *ptr +rank(0)
    ! Statement: f_inout_native*
    subroutine nbcastinteger_0d(cptr, ptr)
    ...
    end subroutine nbcastinteger_0d
    ...
    ! Argument:  int *ptr +rank(1)
    ! Statement: f_inout_native*
    subroutine nbcastinteger_1d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(:)
    ...
    end subroutine nbcastinteger_1d
    ...
    ! Argument:  int *ptr +rank(2)
    ! Statement: f_inout_native*
    subroutine nbcastinteger_2d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(:,:)
    ...
    end subroutine nbcastinteger_2d
    ...
    ! Argument:  int *ptr +rank(3)
    ! Statement: f_inout_native*
    subroutine nbcastinteger_3d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(:,:,:)
    ...
    end subroutine nbcastinteger_3d
