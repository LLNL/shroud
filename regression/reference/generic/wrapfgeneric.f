...
module generic_mod
    ...
    ! Match:     c_default
    interface
        function c_sum_array(values, nvalues) &
                result(SHT_rv) &
                bind(C, name="SumArray")
            use iso_c_binding, only : C_INT
            implicit none
            integer(C_INT), intent(INOUT) :: values
            integer(C_INT), value, intent(IN) :: nvalues
            integer(C_INT) :: SHT_rv
        end function c_sum_array
    end interface
    ...
    ! Match:     c_default
    interface
        function c_sum_array_array(values, nvalues) &
                result(SHT_rv) &
                bind(C, name="SumArray")
            use iso_c_binding, only : C_INT
            implicit none
            ...
            integer(C_INT), value, intent(IN) :: nvalues
            integer(C_INT) :: SHT_rv
        end function c_sum_array_array
    end interface
    ...
    interface sum_array
        module procedure sum_array_scalar
        module procedure sum_array_array
    end interface sum_array
...
contains
    ...
    !!
    !<
    function sum_array_scalar(values, nvalues) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT
        integer(C_INT), intent(INOUT) :: values
        integer(C_INT), value, intent(IN) :: nvalues
        integer(C_INT) :: SHT_rv
        ! splicer begin function.sum_array_scalar
        SHT_rv = c_sum_array(values, nvalues)
        ! splicer end function.sum_array_scalar
    end function sum_array_scalar
    ...
    !!
    !<
    function sum_array_array(values, nvalues) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT
        integer(C_INT), intent(INOUT) :: values(:)
        integer(C_INT), value, intent(IN) :: nvalues
        integer(C_INT) :: SHT_rv
        ! splicer begin function.sum_array_array
        SHT_rv = c_sum_array_array(values, nvalues)
        ! splicer end function.sum_array_array
    end function sum_array_array
