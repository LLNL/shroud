...
module generic_mod
    ...
    interface
        subroutine c_last_function_called_bufferify(SHT_rv, SHT_rv_len) &
                bind(C, name="GEN_LastFunctionCalled_bufferify")
    ...
    ! Statement: f_in_native
    interface
        function c_sum_values_0d_bufferify(values, nvalues) &
                result(SHT_rv) &
                bind(C, name="GEN_SumValues_0d_bufferify")
            use iso_c_binding, only : C_INT
            implicit none
            integer(C_INT), intent(IN) :: values
            integer(C_INT), value, intent(IN) :: nvalues
            integer(C_INT) :: SHT_rv
        end function c_sum_values_0d_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        function c_sum_values_1d_bufferify(values, nvalues) &
                result(SHT_rv) &
                bind(C, name="GEN_SumValues_1d_bufferify")
            use iso_c_binding, only : C_INT
            implicit none
            integer(C_INT), intent(IN) :: values(*)
            integer(C_INT), value, intent(IN) :: nvalues
            integer(C_INT) :: SHT_rv
        end function c_sum_values_1d_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        function c_sum_values_2d_bufferify(values, nvalues) &
                result(SHT_rv) &
                bind(C, name="GEN_SumValues_2d_bufferify")
            use iso_c_binding, only : C_INT
            implicit none
            integer(C_INT), intent(IN) :: values(*)
            integer(C_INT), value, intent(IN) :: nvalues
            integer(C_INT) :: SHT_rv
        end function c_sum_values_2d_bufferify
    end interface
    ...
    interface
        subroutine c_ba_nbcastinteger(cptr, ptr) &
                bind(C, name="BA_nbcastinteger")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: cptr(*)
            integer(C_INT), intent(INOUT) :: ptr
        end subroutine c_ba_nbcastinteger
    end interface
    ...
    ! Statement: f_inout_native*
    interface
        subroutine c_ba_nbcastinteger_0d_bufferify(cptr, ptr) &
                bind(C, name="GEN_BA_nbcastinteger_0d_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: cptr(*)
            integer(C_INT), intent(INOUT) :: ptr
        end subroutine c_ba_nbcastinteger_0d_bufferify
    end interface
    ...
    ! Statement: f_inout_native*
    interface
        subroutine c_ba_nbcastinteger_1d_bufferify(cptr, ptr) &
                bind(C, name="GEN_BA_nbcastinteger_1d_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: cptr(*)
            integer(C_INT), intent(INOUT) :: ptr(*)
        end subroutine c_ba_nbcastinteger_1d_bufferify
    end interface
    ...
    ! Statement: f_inout_native*
    interface
        subroutine c_ba_nbcastinteger_2d_bufferify(cptr, ptr) &
                bind(C, name="GEN_BA_nbcastinteger_2d_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: cptr(*)
            integer(C_INT), intent(INOUT) :: ptr(*)
        end subroutine c_ba_nbcastinteger_2d_bufferify
    end interface
    ...
    ! Statement: f_inout_native*
    interface
        subroutine c_ba_nbcastinteger_3d_bufferify(cptr, ptr) &
                bind(C, name="GEN_BA_nbcastinteger_3d_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: cptr(*)
            integer(C_INT), intent(INOUT) :: ptr(*)
        end subroutine c_ba_nbcastinteger_3d_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        subroutine c_assign_values_broadcast_bufferify(from, nfrom, to, &
                nto) &
                bind(C, name="GEN_AssignValues_broadcast_bufferify")
            use iso_c_binding, only : C_INT
            implicit none
            integer(C_INT), intent(IN) :: from
            integer(C_INT), value, intent(IN) :: nfrom
            integer(C_INT), intent(INOUT) :: to(*)
            integer(C_INT), value, intent(IN) :: nto
        end subroutine c_assign_values_broadcast_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        subroutine c_assign_values_copy_bufferify(from, nfrom, to, nto) &
                bind(C, name="GEN_AssignValues_copy_bufferify")
            use iso_c_binding, only : C_INT
            implicit none
            integer(C_INT), intent(IN) :: from(*)
            integer(C_INT), value, intent(IN) :: nfrom
            integer(C_INT), intent(INOUT) :: to(*)
            integer(C_INT), value, intent(IN) :: nto
        end subroutine c_assign_values_copy_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        subroutine c_save_pointer_float1d_bufferify(addr, type, size) &
                bind(C, name="GEN_SavePointer_float1d_bufferify")
            use iso_c_binding, only : C_FLOAT, C_INT, C_SIZE_T
            implicit none
            real(C_FLOAT), intent(IN) :: addr(*)
            integer(C_INT), value, intent(IN) :: type
            integer(C_SIZE_T), value, intent(IN) :: size
        end subroutine c_save_pointer_float1d_bufferify
    end interface
#endif
    ...
    ! Statement: f_in_native
    interface
        subroutine c_save_pointer_float2d_bufferify(addr, type, size) &
                bind(C, name="GEN_SavePointer_float2d_bufferify")
            use iso_c_binding, only : C_FLOAT, C_INT, C_SIZE_T
            implicit none
            real(C_FLOAT), intent(IN) :: addr(*)
            integer(C_INT), value, intent(IN) :: type
            integer(C_SIZE_T), value, intent(IN) :: size
        end subroutine c_save_pointer_float2d_bufferify
    end interface
#endif
    ...
    ! Statement: f_in_native
    interface
        subroutine c_save_pointer2_float1d_bufferify(addr, type, size) &
                bind(C, name="GEN_SavePointer2_float1d_bufferify")
            use iso_c_binding, only : C_FLOAT, C_INT, C_SIZE_T
            implicit none
            real(C_FLOAT), intent(IN) :: addr(*)
            integer(C_INT), value, intent(IN) :: type
            integer(C_SIZE_T), value, intent(IN) :: size
        end subroutine c_save_pointer2_float1d_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        subroutine c_save_pointer2_float2d_bufferify(addr, type, size) &
                bind(C, name="GEN_SavePointer2_float2d_bufferify")
            use iso_c_binding, only : C_FLOAT, C_INT, C_SIZE_T
            implicit none
            real(C_FLOAT), intent(IN) :: addr(*)
            integer(C_INT), value, intent(IN) :: type
            integer(C_SIZE_T), value, intent(IN) :: size
        end subroutine c_save_pointer2_float2d_bufferify
    end interface
    ...
    ! Statement: f_in_native
    interface
        function c_update_struct_as_class_bufferify(arg, inew) &
                result(SHT_rv) &
                bind(C, name="GEN_UpdateStructAsClass_bufferify")
            use iso_c_binding, only : C_LONG
            import :: GEN_SHROUD_capsule_data
            implicit none
            ...
            integer(C_LONG) :: SHT_rv
        end function c_update_struct_as_class_bufferify
    end interface
    ...
    interface nbcastinteger
        module procedure ba_nbcastinteger_0d
        module procedure ba_nbcastinteger_1d
        module procedure ba_nbcastinteger_2d
        module procedure ba_nbcastinteger_3d
    end interface nbcastinteger
...
contains
    ...
    function sum_values_0d(values, nvalues) &
        ...
        SHT_rv = c_sum_values_0d_bufferify(values, nvalues)
    ...
    function sum_values_1d(values, nvalues) &
        ...
        SHT_rv = c_sum_values_1d_bufferify(values, nvalues)
    ...
    function sum_values_2d(values, nvalues) &
        ...
        SHT_rv = c_sum_values_2d_bufferify(values, nvalues)
    ...
    ! Argument:  int *ptr +rank(0)
    ! Statement: f_inout_native*
    subroutine ba_nbcastinteger_0d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr
        ! splicer begin function.ba_nbcastinteger_0d
        call c_ba_nbcastinteger_0d_bufferify(trim(cptr)//C_NULL_CHAR, &
            ptr)
        ! splicer end function.ba_nbcastinteger_0d
    end subroutine ba_nbcastinteger_0d
    ...
    ! Argument:  int *ptr +rank(1)
    ! Statement: f_inout_native*
    subroutine ba_nbcastinteger_1d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(:)
        ! splicer begin function.ba_nbcastinteger_1d
        call c_ba_nbcastinteger_1d_bufferify(trim(cptr)//C_NULL_CHAR, &
            ptr)
        ! splicer end function.ba_nbcastinteger_1d
    end subroutine ba_nbcastinteger_1d
    ...
    ! Argument:  int *ptr +rank(2)
    ! Statement: f_inout_native*
    subroutine ba_nbcastinteger_2d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(:,:)
        ! splicer begin function.ba_nbcastinteger_2d
        call c_ba_nbcastinteger_2d_bufferify(trim(cptr)//C_NULL_CHAR, &
            ptr)
        ! splicer end function.ba_nbcastinteger_2d
    end subroutine ba_nbcastinteger_2d
    ...
    ! Argument:  int *ptr +rank(3)
    ! Statement: f_inout_native*
    subroutine ba_nbcastinteger_3d(cptr, ptr)
        use iso_c_binding, only : C_INT, C_NULL_CHAR
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(:,:,:)
        ! splicer begin function.ba_nbcastinteger_3d
        call c_ba_nbcastinteger_3d_bufferify(trim(cptr)//C_NULL_CHAR, &
            ptr)
        ! splicer end function.ba_nbcastinteger_3d
    end subroutine ba_nbcastinteger_3d
    ...
    subroutine assign_values_broadcast(from, nfrom, to, nto)
        ...
        call c_assign_values_broadcast_bufferify(from, nfrom, to, nto)
    ...
    subroutine assign_values_copy(from, nfrom, to, nto)
        ...
        call c_assign_values_copy_bufferify(from, nfrom, to, nto)
    ...
    subroutine save_pointer_float1d(addr)
        ...
        call c_save_pointer_float1d_bufferify(addr, SH_type, SH_size)
    ...
    subroutine save_pointer_float2d(addr)
        ...
        SH_type = T_FLOAT
        SH_size = size(addr,kind=C_SIZE_T)
        call c_save_pointer_float2d_bufferify(addr, SH_type, SH_size)
    ...
    subroutine save_pointer2_float1d(addr)
        ...
        SH_size = size(addr,kind=C_SIZE_T)
        call c_save_pointer2_float1d_bufferify(addr, SH_type, SH_size)
    ...
    subroutine save_pointer2_float2d(addr)
        ...
        SH_type = SH_TYPE_FLOAT
        SH_size = size(addr,kind=C_SIZE_T)
        call c_save_pointer2_float2d_bufferify(addr, SH_type, SH_size)
    ...
    function update_struct_as_class_int(arg, inew) &
        ...
        SHT_rv = c_update_struct_as_class_bufferify(arg%cxxmem, &
            int(inew, C_LONG))
    ...
    function update_struct_as_class_long(arg, inew) &
        ...
        SHT_rv = c_update_struct_as_class_bufferify(arg%cxxmem, inew)
