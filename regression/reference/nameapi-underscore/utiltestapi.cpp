...
// TopClass1 = TopClass1
void TES_top_class1_assign_TopClass1(TES_top_class1 *lhs_capsule,
    TES_top_class1 *rhs_capsule)
{
...
void TES_inner_namespace_inner_class1_assign_InnerClass1(TES_inner_namespace_inner_class1 *lhs_capsule,
    TES_inner_namespace_inner_class1 *rhs_capsule)
{
    if (lhs_capsule->addr == nullptr) {
        /* LHS is unassigned */
        if (rhs_capsule->cmemflags & SWIG_MEM_RVALUE) {
