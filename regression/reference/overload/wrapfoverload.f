...
!
!>
!! \file wrapfoverload.f
!! \brief Shroud generated wrapper for overload library
!<
...
module overload_mod
    ...
    interface
        subroutine c_apply_nelems_offset(num_elems, offset) &
                bind(C, name="OVE_apply_nelems_offset")
            import :: INDEXTYPE
            implicit none
            integer(INDEXTYPE), value, intent(IN) :: num_elems
    ...
    interface
        subroutine c_apply_nelems_offset_stride(num_elems, offset, &
                stride) &
                bind(C, name="OVE_apply_nelems_offset_stride")
            import :: INDEXTYPE
            implicit none
            integer(INDEXTYPE), value, intent(IN) :: num_elems
            integer(INDEXTYPE), value, intent(IN) :: offset
    ...
    interface
        subroutine c_apply_type_nelems(type, num_elems) &
                bind(C, name="OVE_apply_type_nelems")
    ...
    interface
        subroutine c_apply_type_nelems_offset(type, num_elems, offset) &
                bind(C, name="OVE_apply_type_nelems_offset")
            use iso_c_binding, only : C_INT
            import :: INDEXTYPE
            implicit none
            integer(C_INT), value, intent(IN) :: type
    ...
    interface
        subroutine c_apply_type_nelems_offset_stride(type, num_elems, &
                offset, stride) &
                bind(C, name="OVE_apply_type_nelems_offset_stride")
            use iso_c_binding, only : C_INT
            import :: INDEXTYPE
            implicit none
            integer(C_INT), value, intent(IN) :: type
