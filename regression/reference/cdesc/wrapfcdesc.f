...
module cdesc_mod
    ...
    interface
        ...
        subroutine c_rank2_in(arg) &
            ...
            implicit none
            type(CDE_SHROUD_array), intent(OUT) :: arg
        ...
        subroutine c_get_scalar1(name, value) &
            ...
            type(CDE_SHROUD_array), intent(OUT) :: value
        ...
        subroutine c_get_scalar1_0_bufferify(name, SHT_name_len, value) &
        ...
        ! Attrs:     +api(cdesc)+intent(out)
        ! Statement: f_out_native_*_cdesc
        subroutine c_get_scalar1_1_bufferify(name, SHT_name_len, value) &
