...
// splicer begin function.passStructByValue
    ...
    if (SHPy_arg == NULL) {
        PyErr_SetString(PyExc_ValueError,
            "arg must be a 0-D array of Cstruct1");
        goto fail;
    }
...
// splicer begin function.passStruct2
    ...
    if (SHPy_s1 == NULL) {
        PyErr_SetString(PyExc_ValueError,
            "s1 must be a 0-D array of Cstruct1");
        goto fail;
    }

    // pre_call
    s1 = PyArray_DATA(SHPy_s1);
...
// splicer begin function.returnStructPtrArray
    ...
    Py_INCREF(PY_Cstruct1_array_descr);
    SHTPy_rv = PyArray_NewFromDescr(&PyArray_Type, 
        PY_Cstruct1_array_descr, 1, SHD_rv, NULL, SHCXX_rv, 0, NULL);
    if (SHTPy_rv == NULL) goto fail;
...
// splicer begin function.get_global_struct_list
    ...
    SHTPy_rv = PyArray_NewFromDescr(&PyArray_Type, 
        PY_Cstruct_list_array_descr, 0, NULL, NULL, SHCXX_rv, 0, NULL);
    if (SHTPy_rv == NULL) goto fail;
...
static PyArray_Descr *PY_Cstruct_list_create_array_descr(void)
{
    int ierr;
    PyObject *obj = NULL;
    PyObject * lnames = NULL;
...
static PyArray_Descr *PY_Cstruct_numpy_create_array_descr(void)
{
    int ierr;
    PyObject *obj = NULL;
    PyObject * lnames = NULL;
