...
PyObject *PP_Cstruct_as_class_to_Object(Cstruct_as_class *addr)
{
    ...
    voidobj = PyCapsule_New(addr, PY_Cstruct_as_class_capsule_name, NULL);
    args = PyTuple_New(1);
    PyTuple_SET_ITEM(args, 0, voidobj);
    rv = PyObject_Call((PyObject *) &PY_Cstruct_as_class_Type, args, NULL);
    Py_DECREF(args);
    return rv;
    // splicer end class.Cstruct_as_class.utility.to_object
}
...
static PY_SHROUD_dtor_context PY_SHROUD_capsule_context[] = {
    ...
    {"c Cstruct_as_class *", PY_SHROUD_capsule_destructor_1},
    {NULL, NULL},
};
