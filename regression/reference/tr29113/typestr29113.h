...
#ifndef TYPESTR29113_H
#define TYPESTR29113_H
...
struct s_TR2_SHROUD_capsule_data {
    void *addr;     /* address of C++ memory */
    int idtor;      /* index of destructor */
};
typedef struct s_TR2_SHROUD_capsule_data TR2_SHROUD_capsule_data;
...
struct s_TR2_SHROUD_array {
    TR2_SHROUD_capsule_data cxx;      /* address of C++ memory */
    union {
        const void * base;
        const char * ccharp;
    } addr;
...
typedef struct s_TR2_SHROUD_array TR2_SHROUD_array;
