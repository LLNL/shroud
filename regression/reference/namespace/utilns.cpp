...
void NS_nswork_ClassWork_assign_ClassWork(NS_nswork_ClassWork *lhs_capsule,
    NS_nswork_ClassWork *rhs_capsule)
{
    if (lhs_capsule->addr == nullptr) {
        ...
        if (lhs_capsule->cmemflags & SWIG_MEM_OWN) {
            NS_SHROUD_memory_destructor(
                (NS_SHROUD_capsule_data *) lhs_capsule);
        }
