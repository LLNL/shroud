...
module generic_mod
    ...
    interface
        subroutine c_last_function_called_CFI(SHT_rv) &
                bind(C, name="GEN_LastFunctionCalled_CFI")
            implicit none
            character(len=*), intent(OUT) :: SHT_rv
        end subroutine c_last_function_called_CFI
    end interface
    ...
    interface
        subroutine ba_nbcastinteger(cptr, ptr) &
                bind(C, name="GEN_BA_nbcastinteger_CFI")
            use iso_c_binding, only : C_INT
            implicit none
            character(len=*), intent(IN) :: cptr
            integer(C_INT), intent(INOUT) :: ptr(..)
        end subroutine ba_nbcastinteger
    end interface
...
contains
    ...
    function last_function_called() &
        ...
        call c_last_function_called_CFI(SHT_rv)
    ...
    subroutine ba_nbcastinteger(cptr, ptr)
        ...
        character(len=*), intent(IN) :: cptr
        integer(C_INT), intent(INOUT) :: ptr(..)
        ! splicer begin function.ba_nbcastinteger
        call c_ba_nbcastinteger_CFI(cptr, ptr)
        ! splicer end function.ba_nbcastinteger
    end subroutine ba_nbcastinteger
#endif
