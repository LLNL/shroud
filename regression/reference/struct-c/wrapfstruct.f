...
module struct_mod
    ...
    contains
        ...
        procedure :: get_name_copy => cstruct_as_class2_get_name_copy
    ...
    ! Statement: f_getter_char*_cdesc_pointer_library
    interface
    ...
    interface
        subroutine c_cstruct_as_class2_get_name_copy(self, val, &
                SHT_rv_len) &
                bind(C, name="STR_Cstruct_as_class2_get_name_copy")
        ...
        end subroutine c_cstruct_as_class2_get_name_copy
    end interface
    ...
    ! Statement: f_getter_native*_pointer_library
    ! ----------------------------------------
...
contains
    ...
    ! Function:  char *get_name_copy +deref(copy)+intent(getter)
    ! Statement: f_getter_char*_buf_copy
    subroutine cstruct_as_class2_get_name_copy(obj, val)
        use iso_c_binding, only : C_INT
        class(cstruct_as_class2), intent(INOUT) :: obj
        ...
        call c_cstruct_as_class2_get_name_copy(obj%cxxmem, val, &
            SHT_rv_len)
        ! splicer end class.Cstruct_as_class2.method.get_name_copy
    end subroutine cstruct_as_class2_get_name_copy
