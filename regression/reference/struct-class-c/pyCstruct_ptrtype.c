...
// Attrs:     +intent(in)+struct_member(<shroud.ast.VariableNode object at 0x2aaab05a9f28>)
// Requested: py_ctor_char_*_numpy
// Match:     py_ctor_char_*
// ----------------------------------------
// Argument:  const double * const_dvalue
// Attrs:     +intent(in)+struct_member(<shroud.ast.VariableNode object at 0x2aaab05a9f98>)
