...
// ----------------------------------------
// Argument:  int nitems
// Attrs:     +intent(in)+struct_member(<shroud.ast.VariableNode object at 0x2aaab05e12e8>)
// Requested: py_ctor_native_scalar_list
// Match:     py_ctor_native
// ----------------------------------------
// Argument:  int * ivalue +dimension(nitems+nitems)
// Attrs:     +intent(in)+struct_member(<shroud.ast.VariableNode object at 0x2aaab05e1198>)
// Requested: py_ctor_native_*_list
// Match:     py_ctor_native_*
// ----------------------------------------
// Argument:  double * dvalue +dimension(nitems*TWO)
// Attrs:     +intent(in)+struct_member(<shroud.ast.VariableNode object at 0x2aaab05e14a8>)
// Requested: py_ctor_native_*_list
// Match:     py_ctor_native_*
// ----------------------------------------
// Argument:  char * * svalue +dimension(nitems)
// Attrs:     +intent(in)+struct_member(<shroud.ast.VariableNode object at 0x2aaab05e1400>)
