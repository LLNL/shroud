...
#endif
// splicer begin class.Worker.impl.C_definition
// splicer end class.Worker.impl.C_definition
// splicer begin class.Worker.impl.additional_methods
// splicer end class.Worker.impl.additional_methods
static void
...
// splicer end class.Worker.impl.after_methods
...
PyTypeObject PY_Worker_Type = {
    ...
    0,                              /* tp_subclasses */
    0,                              /* tp_weaklist */
    (destructor)PY_Worker_tp_del,                 /* tp_del */
    0,                              /* tp_version_tag */
#if PY_MAJOR_VERSION >= 3
