...
module scope_mod
    ...
    interface
        ...
        subroutine c_ns3_data_pointer_get_items(SH_this, SHT_rv_cdesc) &
                bind(C, name="SCO_ns3_DataPointer_get_items")
            import :: SCO_SHROUD_array, data_pointer
            implicit none
            type(data_pointer), intent(IN) :: SH_this
            type(SCO_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
        end subroutine c_ns3_data_pointer_get_items
        ...
        subroutine ns3_data_pointer_set_items(SH_this, val) &
                bind(C, name="SCO_ns3_DataPointer_set_items")
            use iso_c_binding, only : C_INT
            import :: data_pointer
            implicit none
            type(data_pointer), intent(INOUT) :: SH_this
            integer(C_INT), intent(IN) :: val(*)
        end subroutine ns3_data_pointer_set_items
    end interface
...
contains
    ...
    ! Argument:  ns3::DataPointer *SH_this +intent(in)
    ! Statement: f_in_struct*
    function ns3_data_pointer_get_items(SH_this) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, c_f_pointer
        type(data_pointer), intent(IN) :: SH_this
        integer(C_INT), pointer :: SHT_rv(:)
        ! splicer begin namespace.ns3.function.data_pointer_get_items
        type(SCO_SHROUD_array) :: SHT_rv_cdesc
        call c_ns3_data_pointer_get_items(SH_this, SHT_rv_cdesc)
        call c_f_pointer(SHT_rv_cdesc%base_addr, SHT_rv, &
            SHT_rv_cdesc%shape(1:1))
        ! splicer end namespace.ns3.function.data_pointer_get_items
    end function ns3_data_pointer_get_items
    ...
    subroutine ns3_data_pointer_set_items(SH_this, val)
        ...
        type(data_pointer), intent(INOUT) :: SH_this
        integer(C_INT), intent(IN) :: val(:)
        ! splicer begin namespace.ns3.function.data_pointer_set_items
        call c_ns3_data_pointer_set_items(SH_this, val)
        ! splicer end namespace.ns3.function.data_pointer_set_items
    end subroutine ns3_data_pointer_set_items
#endif
