...
module cxxlibrary_mod
    ...
    contains
        procedure :: declare_0_int => class1_declare_0_int
        ...
        generic :: declare => declare_0_int, declare_1_int
    ...
    interface
        ...
        subroutine c_class1_declare_0(self) &
        ...
        subroutine c_class1_declare_1(self, length) &
        ...
        ! Attrs:     +intent(in)
        ! Statement: f_in_struct_*
        subroutine c_nested_get_child_bufferify(SH_this, SHT_rv_cdesc) &
                bind(C, name="CXX_nested_get_child_bufferify")
            import :: CXX_SHROUD_array, nested
            implicit none
            type(nested), intent(IN) :: SH_this
            type(CXX_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
        end subroutine c_nested_get_child_bufferify
    ...
    interface class1_declare
        module procedure class1_declare_0_int
...
contains
    ...
    ! Generated by has_default_arg - return_this - fortran_generic
    ! ----------------------------------------
    ! Function:  void declare
    ! Attrs:     +api(capptr)+intent(subroutine)
    ! Statement: f_subroutine
    subroutine class1_declare_0_int(obj)
        class(class1) :: obj
        ! splicer begin class.Class1.method.declare_0_int
        call c_class1_declare_0(obj%cxxmem)
        ! splicer end class.Class1.method.declare_0_int
    end subroutine class1_declare_0_int
    ...
    ! Attrs:     +intent(in)
    ! Statement: f_in_native_scalar
    subroutine class1_declare_1_int(obj, length)
        use iso_c_binding, only : C_INT
        class(class1) :: obj
        integer(C_INT), value, intent(IN) :: length
        ! splicer begin class.Class1.method.declare_1_int
        call c_class1_declare_1(obj%cxxmem, length)
    ...
    function nested_get_child(SH_this) &
        ...
        type(CXX_SHROUD_array) :: SHT_rv_cdesc
        call c_nested_get_child_bufferify(SH_this, SHT_rv_cdesc)
        call c_f_pointer(SHT_rv_cdesc%base_addr, SHT_rv, &
