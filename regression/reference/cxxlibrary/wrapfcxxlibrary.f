...
module cxxlibrary_mod
    ...
    contains
        ...
        procedure :: get_view_from_class => class1_get_view_from_class
    ...
    interface
        ...
        subroutine c_class1_dtor(self) &
                bind(C, name="CXX_Class1_dtor")
            import :: CXX_SHROUD_capsule_data
            implicit none
            type(CXX_SHROUD_capsule_data), intent(INOUT) :: self
        ...
        function c_class1_get_view_from_class(self, path) &
                result(SHT_rv) &
                bind(C, name="CXX_Class1_getViewFromClass")
        ...
        function c_class1_get_view_from_class_bufferify(self, path, &
                SHT_path_len) &
                result(SHT_rv) &
                bind(C, name="CXX_Class1_getViewFromClass_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            import :: CXX_SHROUD_capsule_data
            implicit none
            type(CXX_SHROUD_capsule_data), intent(IN) :: self
            ...
            integer(C_INT) :: SHT_rv
        end function c_class1_get_view_from_class_bufferify
        ...
        ! Argument:  long idx
        ! Statement: f_in_native
        subroutine c_get_group_name_bufferify(idx, SHT_rv, SHT_rv_len) &
                bind(C, name="CXX_getGroupName_bufferify")
        ...
        end subroutine c_get_group_name_bufferify
        ...
        ! Statement: c_in_native
        ! ----------------------------------------
        ! Argument:  long num_elems
        ! Statement: c_in_native
        function c_create_view_from_type(path, type, num_elems, SHT_rv) &
                result(SHT_rv_ptr) &
                bind(C, name="CXX_createView_from_type")
            ...
            type(CXX_SHROUD_capsule_data), intent(OUT) :: SHT_rv
            type(C_PTR) :: SHT_rv_ptr
        end function c_create_view_from_type
        ...
        ! Argument:  long num_elems
        ! Statement: f_in_native
        subroutine c_create_view_from_type_bufferify(path, SHT_path_len, &
                type, num_elems, SHT_rv) &
                bind(C, name="CXX_createView_from_type_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT, C_LONG
            import :: CXX_SHROUD_capsule_data
            implicit none
            character(kind=C_CHAR), intent(IN) :: path(*)
            ...
            integer(C_LONG), value, intent(IN) :: num_elems
            type(CXX_SHROUD_capsule_data), intent(OUT) :: SHT_rv
        end subroutine c_create_view_from_type_bufferify
        ...
        ! Statement: c_in_native
        ! ----------------------------------------
        ! Argument:  void *external_ptr
        ! Statement: c_in_void*
        function c_create_view_from_type_external(path, type, num_elems, &
                external_ptr, SHT_rv) &
                result(SHT_rv_ptr) &
                bind(C, name="CXX_createView_from_type_external")
            use iso_c_binding, only : C_CHAR, C_INT, C_LONG, C_PTR
            import :: CXX_SHROUD_capsule_data
            implicit none
            character(kind=C_CHAR), intent(IN) :: path(*)
            ...
            type(CXX_SHROUD_capsule_data), intent(OUT) :: SHT_rv
            type(C_PTR) :: SHT_rv_ptr
        end function c_create_view_from_type_external
        ...
        ! Argument:  void *external_ptr
        ! Statement: f_in_void*
        subroutine c_create_view_from_type_external_bufferify(path, &
                SHT_path_len, type, num_elems, external_ptr, SHT_rv) &
                bind(C, name="CXX_createView_from_type_external_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT, C_LONG, C_PTR
            import :: CXX_SHROUD_capsule_data
            implicit none
            character(kind=C_CHAR), intent(IN) :: path(*)
            ...
            type(C_PTR), value, intent(IN) :: external_ptr
            type(CXX_SHROUD_capsule_data), intent(OUT) :: SHT_rv
        end subroutine c_create_view_from_type_external_bufferify
    ...
    interface create_view
        module procedure create_view_from_type_int32_t
        module procedure create_view_from_type_int64_t
        module procedure create_view_from_type_external_int32_t
        module procedure create_view_from_type_external_int64_t
    end interface create_view
...
contains
    ...
    function class1_get_view_from_class(obj, path) &
        ...
        SHT_rv = c_class1_get_view_from_class_bufferify(obj%cxxmem, &
            path, SHT_path_len)
        ! splicer end class.Class1.method.get_view_from_class
    end function class1_get_view_from_class
    ...
    function get_group_name_int32_t(idx) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, C_INT32_T, C_LONG
        ...
        call c_get_group_name_bufferify(int(idx, C_LONG), SHT_rv, &
            SHT_rv_len)
    ...
    function get_group_name_int64_t(idx) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, C_INT64_T, C_LONG
    ...
    ! Statement: f_in_native
    ! ----------------------------------------
    ! Argument:  int32_t num_elems
    ! Statement: f_in_native
    ! Argument:  long num_elems
    function create_view_from_type_int32_t(path, type, num_elems) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, C_INT32_T, C_LONG
        character(len=*), intent(IN) :: path
        integer(C_INT), value, intent(IN) :: type
        ...
        type(class1) :: SHT_rv
        ! splicer begin function.create_view_from_type_int32_t
        integer(C_INT) SHT_path_len
        SHT_path_len = len(path, kind=C_INT)
        call c_create_view_from_type_bufferify(path, SHT_path_len, type, &
            int(num_elems, C_LONG), SHT_rv%cxxmem)
        ! splicer end function.create_view_from_type_int32_t
    end function create_view_from_type_int32_t
    ...
    ! Statement: f_in_native
    ! ----------------------------------------
    ! Argument:  int64_t num_elems
    ! Statement: f_in_native
    ! Argument:  long num_elems
    function create_view_from_type_int64_t(path, type, num_elems) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, C_INT64_T, C_LONG
        character(len=*), intent(IN) :: path
        integer(C_INT), value, intent(IN) :: type
        ...
        type(class1) :: SHT_rv
        ! splicer begin function.create_view_from_type_int64_t
        integer(C_INT) SHT_path_len
        SHT_path_len = len(path, kind=C_INT)
        call c_create_view_from_type_bufferify(path, SHT_path_len, type, &
            int(num_elems, C_LONG), SHT_rv%cxxmem)
        ! splicer end function.create_view_from_type_int64_t
    end function create_view_from_type_int64_t
    ...
    ! Argument:  void *external_ptr
    ! Statement: f_in_void*
    function create_view_from_type_external_int32_t(path, type, &
            num_elems, external_ptr) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, C_INT32_T, C_LONG, C_PTR
        character(len=*), intent(IN) :: path
        integer(C_INT), value, intent(IN) :: type
        integer(C_INT32_T), value, intent(IN) :: num_elems
        type(C_PTR), intent(IN) :: external_ptr
        type(class1) :: SHT_rv
        ! splicer begin function.create_view_from_type_external_int32_t
        integer(C_INT) SHT_path_len
        SHT_path_len = len(path, kind=C_INT)
        call c_create_view_from_type_external_bufferify(path, &
            SHT_path_len, type, int(num_elems, C_LONG), external_ptr, &
            SHT_rv%cxxmem)
        ! splicer end function.create_view_from_type_external_int32_t
    end function create_view_from_type_external_int32_t
    ...
    ! Argument:  void *external_ptr
    ! Statement: f_in_void*
    function create_view_from_type_external_int64_t(path, type, &
            num_elems, external_ptr) &
            result(SHT_rv)
        use iso_c_binding, only : C_INT, C_INT64_T, C_LONG, C_PTR
        character(len=*), intent(IN) :: path
        integer(C_INT), value, intent(IN) :: type
        integer(C_INT64_T), value, intent(IN) :: num_elems
        type(C_PTR), intent(IN) :: external_ptr
        type(class1) :: SHT_rv
        ! splicer begin function.create_view_from_type_external_int64_t
        integer(C_INT) SHT_path_len
        SHT_path_len = len(path, kind=C_INT)
        call c_create_view_from_type_external_bufferify(path, &
            SHT_path_len, type, int(num_elems, C_LONG), external_ptr, &
            SHT_rv%cxxmem)
        ! splicer end function.create_view_from_type_external_int64_t
    end function create_view_from_type_external_int64_t
