...
{
    // splicer begin function.getGroupName_bufferify
    const std::string &SHC_rv_cxx = getGroupName(idx);
    if (SHC_rv_cxx.empty()) {
    ...
    // splicer end function.getGroupName_bufferify
}
...
void CXX_getView_from_index_bufferify(const long idx,
    CXX_Class1 *SHC_rv)
{
    // splicer begin function.getView_from_index_bufferify
    Class1 *SHC_rv_cxx = getView(idx);
    SHC_rv->addr  = SHC_rv_cxx;
    SHC_rv->idtor = 0;
    SHC_rv->cmemflags = SWIG_MEM_RVALUE;
    // splicer end function.getView_from_index_bufferify
}
...
{
    // splicer begin function.createView_from_type
    const std::string SHC_path_cxx(path);
    Class1 *SHC_rv_cxx = createView(SHC_path_cxx, type, num_elems);
    SHC_rv->addr  = SHC_rv_cxx;
    SHC_rv->idtor = 0;
    SHC_rv->cmemflags = SWIG_MEM_RVALUE;
    return SHC_rv;
    // splicer end function.createView_from_type
}
...
{
    // splicer begin function.createView_from_type_bufferify
    int SHC_path_trim = ShroudCharLenTrim(path, SHT_path_len);
    const std::string SHC_path_cxx(path, SHC_path_trim);
    Class1 *SHC_rv_cxx = createView(SHC_path_cxx, type, num_elems);
    SHC_rv->addr  = SHC_rv_cxx;
    SHC_rv->idtor = 0;
    SHC_rv->cmemflags = SWIG_MEM_RVALUE;
    // splicer end function.createView_from_type_bufferify
}
...
{
    // splicer begin function.createView_from_type_external
    const std::string SHC_path_cxx(path);
    Class1 *SHC_rv_cxx = createView(SHC_path_cxx, type, num_elems,
        external_ptr);
    SHC_rv->addr  = SHC_rv_cxx;
    ...
    SHC_rv->cmemflags = SWIG_MEM_RVALUE;
    return SHC_rv;
    // splicer end function.createView_from_type_external
}
...
void CXX_createView_from_type_external_bufferify(char *path,
    ...
    CXX_Class1 *SHC_rv)
{
    // splicer begin function.createView_from_type_external_bufferify
    int SHC_path_trim = ShroudCharLenTrim(path, SHT_path_len);
    const std::string SHC_path_cxx(path, SHC_path_trim);
    Class1 *SHC_rv_cxx = createView(SHC_path_cxx, type, num_elems,
        external_ptr);
    ...
    SHC_rv->idtor = 0;
    SHC_rv->cmemflags = SWIG_MEM_RVALUE;
    // splicer end function.createView_from_type_external_bufferify
}
