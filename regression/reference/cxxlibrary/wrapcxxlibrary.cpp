...
// ----------------------------------------
// Function:  nested * nested_get_parent +api(cdesc)+deref(pointer)+intent(getter)
...
// Generated by getter/setter
// ----------------------------------------
// Function:  nested * * nested_get_child +api(cdesc)+deref(pointer)+dimension(sublevels)+intent(getter)
// Statement: f_getter_struct_**_cdesc_pointer
// ----------------------------------------
// Argument:  nested * SH_this +intent(in)
// Statement: f_in_struct_*
