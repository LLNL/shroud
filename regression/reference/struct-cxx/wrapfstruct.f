...
contains
    ...
    ! Function:  Cstruct1 returnStructByValue
    ! Attrs:     +intent(function)
    ! Requested: f_function_struct_scalar
    ! Match:     f_function
    ! Attrs:     +intent(function)
    ! Requested: c_function_struct_scalar
    ! Match:     c_function_struct
    ...
    function return_struct_by_value(i, d) &
        ...
        SHT_rv = c_return_struct_by_value(i, d)
    ...
    ! Requested: f_getter_native_*_buf_pointer
    ! Match:     f_getter
    ! Attrs:     +api(buf)+deref(pointer)+intent(getter)+struct(Cstruct_ptr)
    ! Requested: c_getter_native_*_buf_pointer
    ! Match:     c_getter_native_*
    ...
    function cstruct_ptr_get_const_dvalue(SH_this) &
        ...
        SHT_rv = c_cstruct_ptr_get_const_dvalue_bufferify(SH_this)
