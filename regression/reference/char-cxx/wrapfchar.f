...
module char_mod
    ...
    type, bind(C) :: CHA_SHROUD_capsule_data
        type(C_PTR) :: addr = C_NULL_PTR  ! address of C++ memory
        integer(C_INT) :: idtor = 0       ! index of destructor
    end type CHA_SHROUD_capsule_data
    ...
    interface
        function c_get_const_string_result() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringResult")
            use iso_c_binding, only : C_CHAR
            implicit none
    ...
    interface
        subroutine c_get_const_string_result_bufferify(SHT_rv_cdesc, &
                SHT_rv_capsule) &
                bind(C, name="CHA_getConstStringResult_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_len() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringLen")
            use iso_c_binding, only : C_CHAR
            implicit none
            character(kind=C_CHAR) :: SHT_rv(*)
    ...
    interface
        subroutine c_get_const_string_len_bufferify(SHT_rv, SHT_rv_len) &
                bind(C, name="CHA_getConstStringLen_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: SHT_rv(*)
            integer(C_INT), value, intent(IN) :: SHT_rv_len
    ...
    interface
        function c_get_const_string_as_arg() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringAsArg")
            use iso_c_binding, only : C_CHAR
            implicit none
            character(kind=C_CHAR) :: SHT_rv(*)
    ...
    interface
        subroutine c_get_const_string_as_arg_bufferify(output, noutput) &
                bind(C, name="CHA_getConstStringAsArg_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: output(*)
            integer(C_INT), value, intent(IN) :: noutput
    ...
    interface
        function c_get_const_string_alloc() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringAlloc")
            use iso_c_binding, only : C_CHAR
            implicit none
            character(kind=C_CHAR) :: SHT_rv(*)
    ...
    interface
        subroutine c_get_const_string_alloc_bufferify(SHT_rv_cdesc, &
                SHT_rv_capsule) &
                bind(C, name="CHA_getConstStringAlloc_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_ref_pure() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringRefPure")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ref_pure_bufferify(SHT_rv_cdesc, &
                SHT_rv_capsule) &
                bind(C, name="CHA_getConstStringRefPure_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_ref_len() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringRefLen")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ref_len_bufferify(SHT_rv, &
                SHT_rv_len) &
                bind(C, name="CHA_getConstStringRefLen_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: SHT_rv(*)
            integer(C_INT), value, intent(IN) :: SHT_rv_len
    ...
    interface
        function c_get_const_string_ref_as_arg() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringRefAsArg")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ref_as_arg_bufferify(output, &
                noutput) &
                bind(C, name="CHA_getConstStringRefAsArg_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: output(*)
            integer(C_INT), value, intent(IN) :: noutput
    ...
    interface
        function c_get_const_string_ref_len_empty() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringRefLenEmpty")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ref_len_empty_bufferify(SHT_rv, &
                SHT_rv_len) &
                bind(C, name="CHA_getConstStringRefLenEmpty_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: SHT_rv(*)
            integer(C_INT), value, intent(IN) :: SHT_rv_len
    ...
    interface
        function c_get_const_string_ref_alloc() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringRefAlloc")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ref_alloc_bufferify(SHT_rv_cdesc, &
                SHT_rv_capsule) &
                bind(C, name="CHA_getConstStringRefAlloc_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_ptr_len() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringPtrLen")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ptr_len_bufferify(SHT_rv, &
                SHT_rv_len) &
                bind(C, name="CHA_getConstStringPtrLen_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: SHT_rv(*)
            integer(C_INT), value, intent(IN) :: SHT_rv_len
    ...
    interface
        function c_get_const_string_ptr_alloc() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringPtrAlloc")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ptr_alloc_bufferify(SHT_rv_cdesc, &
                SHT_rv_capsule) &
                bind(C, name="CHA_getConstStringPtrAlloc_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_ptr_owns_alloc() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringPtrOwnsAlloc")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ptr_owns_alloc_bufferify( &
                ...
                bind(C, name="CHA_getConstStringPtrOwnsAlloc_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_ptr_owns_alloc_pattern() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringPtrOwnsAllocPattern")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ptr_owns_alloc_pattern_bufferify( &
                SHT_rv_cdesc, SHT_rv_capsule) &
                bind(C, name="CHA_getConstStringPtrOwnsAllocPattern_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_rv_capsule
    ...
    interface
        function c_get_const_string_ptr_pointer() &
                result(SHT_rv) &
                bind(C, name="CHA_getConstStringPtrPointer")
            use iso_c_binding, only : C_PTR
            implicit none
            type(C_PTR) :: SHT_rv
    ...
    interface
        subroutine c_get_const_string_ptr_pointer_bufferify( &
                SHT_rv_cdesc) &
                bind(C, name="CHA_getConstStringPtrPointer_bufferify")
            import :: CHA_SHROUD_array
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
    ...
    interface
        subroutine c_accept_string_const_reference(arg1) &
                bind(C, name="CHA_acceptStringConstReference")
            use iso_c_binding, only : C_CHAR
            implicit none
    ...
    interface
        subroutine c_accept_string_const_reference_bufferify(arg1, &
                SHT_arg1_len) &
                bind(C, name="CHA_acceptStringConstReference_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: arg1(*)
    ...
    interface
        subroutine c_accept_string_reference_out(arg1) &
                bind(C, name="CHA_acceptStringReferenceOut")
            use iso_c_binding, only : C_CHAR
            implicit none
    ...
    interface
        subroutine c_accept_string_reference_out_bufferify(arg1, &
                SHT_arg1_len) &
                bind(C, name="CHA_acceptStringReferenceOut_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_accept_string_reference(arg1) &
                bind(C, name="CHA_acceptStringReference")
            use iso_c_binding, only : C_CHAR
            implicit none
    ...
    interface
        subroutine c_accept_string_reference_bufferify(arg1, &
                SHT_arg1_len) &
                bind(C, name="CHA_acceptStringReference_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(INOUT) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_accept_string_pointer_const(arg1) &
                bind(C, name="CHA_acceptStringPointerConst")
            use iso_c_binding, only : C_CHAR
            implicit none
            character(kind=C_CHAR), intent(IN) :: arg1(*)
    ...
    interface
        subroutine c_accept_string_pointer_const_bufferify(arg1, &
                SHT_arg1_len) &
                bind(C, name="CHA_acceptStringPointerConst_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_accept_string_pointer(arg1) &
                bind(C, name="CHA_acceptStringPointer")
            use iso_c_binding, only : C_CHAR
            implicit none
            character(kind=C_CHAR), intent(INOUT) :: arg1(*)
    ...
    interface
        subroutine c_accept_string_pointer_bufferify(arg1, SHT_arg1_len) &
                bind(C, name="CHA_acceptStringPointer_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(INOUT) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_fetch_string_pointer(arg1) &
                bind(C, name="CHA_fetchStringPointer")
            use iso_c_binding, only : C_CHAR
            implicit none
            character(kind=C_CHAR), intent(OUT) :: arg1(*)
    ...
    interface
        subroutine c_fetch_string_pointer_bufferify(arg1, SHT_arg1_len) &
                bind(C, name="CHA_fetchStringPointer_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_accept_string_pointer_len(arg1, nlen) &
                bind(C, name="CHA_acceptStringPointerLen")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(INOUT) :: arg1(*)
    ...
    interface
        subroutine c_accept_string_pointer_len_bufferify(arg1, &
                SHT_arg1_len, nlen) &
                bind(C, name="CHA_acceptStringPointerLen_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(INOUT) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_fetch_string_pointer_len(arg1, nlen) &
                bind(C, name="CHA_fetchStringPointerLen")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: arg1(*)
            integer(C_INT), intent(OUT) :: nlen
    ...
    interface
        subroutine c_fetch_string_pointer_len_bufferify(arg1, &
                SHT_arg1_len, nlen) &
                bind(C, name="CHA_fetchStringPointerLen_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(OUT) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        function c_accept_string_instance(arg1) &
                result(SHT_rv) &
                bind(C, name="CHA_acceptStringInstance")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: arg1(*)
    ...
    interface
        function c_accept_string_instance_bufferify(arg1, SHT_arg1_len) &
                result(SHT_rv) &
                bind(C, name="CHA_acceptStringInstance_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            character(kind=C_CHAR), intent(IN) :: arg1(*)
            integer(C_INT), value, intent(IN) :: SHT_arg1_len
    ...
    interface
        subroutine c_fetch_array_string_arg(strs, nstrs) &
                bind(C, name="CHA_fetchArrayStringArg")
    ...
    interface
        subroutine c_fetch_array_string_arg_bufferify(SHT_strs_cdesc) &
                bind(C, name="CHA_fetchArrayStringArg_bufferify")
            import :: CHA_SHROUD_array
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_strs_cdesc
    ...
    interface
        subroutine c_fetch_array_string_alloc(strs, nstrs) &
                bind(C, name="CHA_fetchArrayStringAlloc")
            use iso_c_binding, only : C_INT, C_PTR
            implicit none
            type(C_PTR), intent(OUT), value :: strs
            integer(C_INT), intent(OUT) :: nstrs
    ...
    interface
        subroutine c_fetch_array_string_alloc_bufferify(SHT_strs_cdesc, &
                SHT_strs_capsule) &
                bind(C, name="CHA_fetchArrayStringAlloc_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_strs_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_strs_capsule
    ...
    interface
        subroutine c_fetch_array_string_alloc_len(strs, nstrs) &
                bind(C, name="CHA_fetchArrayStringAllocLen")
            use iso_c_binding, only : C_INT, C_PTR
            implicit none
            type(C_PTR), intent(OUT), value :: strs
            integer(C_INT), intent(OUT) :: nstrs
    ...
    interface
        subroutine c_fetch_array_string_alloc_len_bufferify( &
                ...
                bind(C, name="CHA_fetchArrayStringAllocLen_bufferify")
            import :: CHA_SHROUD_array, CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_array), intent(OUT) :: SHT_strs_cdesc
            type(CHA_SHROUD_capsule_data), intent(OUT) :: SHT_strs_capsule
    ...
    interface
        subroutine c_post_declare_bufferify(count, name, SHT_name_len) &
                bind(C, name="CHA_PostDeclare_bufferify")
            use iso_c_binding, only : C_CHAR, C_INT
            implicit none
            integer(C_INT), intent(IN) :: count(*)
            character(kind=C_CHAR), intent(INOUT) :: name(*)
    ...
    interface
        ...
        subroutine CHA_SHROUD_array_string_allocatable(dest, src) &
             bind(c,name="CHA_ShroudArrayStringAllocatable")
            import CHA_SHROUD_array, CHA_SHROUD_capsule_data
            type(CHA_SHROUD_array), intent(IN) :: dest
            type(CHA_SHROUD_capsule_data), intent(IN) :: src
        end subroutine CHA_SHROUD_array_string_allocatable
    end interface

    interface
        ! helper capsule_dtor
        ! Delete memory in a capsule.
        subroutine CHA_SHROUD_capsule_dtor(ptr) &
            bind(C, name="CHA_SHROUD_memory_destructor")
            import CHA_SHROUD_capsule_data
            implicit none
            type(CHA_SHROUD_capsule_data), intent(INOUT) :: ptr
        end subroutine CHA_SHROUD_capsule_dtor
    end interface
...
contains
    ...
    function get_const_string_result() &
        ...
        type(CHA_SHROUD_array) :: SHT_rv_cdesc
        type(CHA_SHROUD_capsule_data) :: SHT_rv_capsule
        call c_get_const_string_result_bufferify(SHT_rv_cdesc, &
            SHT_rv_capsule)
        allocate(character(len=SHT_rv_cdesc%elem_len):: SHT_rv)
        call CHA_SHROUD_copy_string(SHT_rv_cdesc, SHT_rv, &
            SHT_rv_cdesc%elem_len)
        call CHA_SHROUD_capsule_dtor(SHT_rv_capsule)
    ...
    subroutine fetch_array_string_arg(strs)
        ...
        type(CHA_SHROUD_array) :: SHT_strs_cdesc
    ...
    subroutine fetch_array_string_alloc(strs)
        ...
        type(CHA_SHROUD_array) :: SHT_strs_cdesc
        type(CHA_SHROUD_capsule_data) :: SHT_strs_capsule
        ...
        SHT_strs_cdesc%base_addr = C_LOC(strs)
        call CHA_SHROUD_array_string_allocatable(SHT_strs_cdesc, SHT_strs_capsule)
        call CHA_SHROUD_capsule_dtor(SHT_strs_capsule)
