...
module classes_mod
    ...
    contains
        ...
        procedure :: get_m_name_ptr => class1_get_m_name_ptr
        procedure :: get_m_name_copy => class1_get_m_name_copy
    ...
    ! start c_class1_get_m_name_ptr
    interface
        subroutine c_class1_get_m_name_ptr(self, SHT_rv_cdesc) &
                bind(C, name="CLA_Class1_get_m_name_ptr")
            import :: CLA_SHROUD_array, CLA_SHROUD_capsule_data
            implicit none
            type(CLA_SHROUD_capsule_data), intent(IN) :: self
            type(CLA_SHROUD_array), intent(OUT) :: SHT_rv_cdesc
        end subroutine c_class1_get_m_name_ptr
    end interface
    ! end c_class1_get_m_name_ptr

    ! Generated by getter/setter
    ! ----------------------------------------
    ! Function:  std::string get_m_name_copy +deref(copy)+intent(getter)
    ! Statement: f_getter_string_buf_copy
    ! start c_class1_get_m_name_copy
    interface
        subroutine c_class1_get_m_name_copy(self, val, SHT_rv_len) &
                bind(C, name="CLA_Class1_get_m_name_copy")
            use iso_c_binding, only : C_CHAR, C_INT
            import :: CLA_SHROUD_capsule_data
            implicit none
            type(CLA_SHROUD_capsule_data), intent(IN) :: self
        ...
        end subroutine c_class1_get_m_name_copy
    end interface
    ! end c_class1_get_m_name_copy
    ...
    ! Statement: f_getter_native*_cdesc_pointer_library
...
contains
    ...
    ! Function:  std::string get_m_name_ptr +deref(pointer)+intent(getter)
    ! Statement: f_getter_string_cdesc_pointer
    ! start class1_get_m_name_ptr
    function class1_get_m_name_ptr(obj) &
            result(SHT_rv)
        class(class1), intent(INOUT) :: obj
        character(len=:), pointer :: SHT_rv
        ! splicer begin class.Class1.method.get_m_name_ptr
        type(CLA_SHROUD_array) :: SHT_rv_cdesc
        call c_class1_get_m_name_ptr(obj%cxxmem, SHT_rv_cdesc)
        call CLA_SHROUD_pointer_string(SHT_rv_cdesc, SHT_rv)
        ! splicer end class.Class1.method.get_m_name_ptr
    end function class1_get_m_name_ptr
    ! end class1_get_m_name_ptr

    ! Generated by getter/setter
    ! ----------------------------------------
    ! Function:  std::string get_m_name_copy +deref(copy)+intent(getter)
    ! Statement: f_getter_string_buf_copy
    ! start class1_get_m_name_copy
    subroutine class1_get_m_name_copy(obj, val)
        use iso_c_binding, only : C_INT
        class(class1), intent(INOUT) :: obj
        character(len=*), intent(OUT) :: val
        ! splicer begin class.Class1.method.get_m_name_copy
        integer(C_INT) SHT_rv_len
        SHT_rv_len = len(val, kind=C_INT)
        call c_class1_get_m_name_copy(obj%cxxmem, val, SHT_rv_len)
        ! splicer end class.Class1.method.get_m_name_copy
    end subroutine class1_get_m_name_copy
    ! end class1_get_m_name_copy
    ...
    subroutine CLA_SHROUD_pointer_string(context, var)
    ...
    end subroutine CLA_SHROUD_pointer_string
