...
module cstruct
 ...
 contains
  ...
  procedure :: release => swigf_Cstruct1_release
  procedure, private :: swigf_Cstruct1_op_assign__
  generic :: assignment(=) => swigf_Cstruct1_op_assign__
 end type Cstruct1
 public :: passStructByValue
 interface Cstruct1
  module procedure swigf_new_Cstruct1
 end interface
...
function swigc_passStructByValue(farg1) &
bind(C, name="_wrap_passStructByValue") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
import :: swigclasswrapper
type(SwigClassWrapper), intent(in) :: farg1
...
subroutine swigf_Cstruct1_release(self)
use, intrinsic :: ISO_C_BINDING
...
function passStructByValue(arg) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
...
farg1 = arg%swigdata
fresult = swigc_passStructByValue(farg1)
swig_result = fresult
end function
